...
int main(void) {
    ...
    printf("\nSET_VALUE\n");
    printf("Establecemos valores para dos claves: 1 y 2 utilizando la funcion set_value:\n");
    int status_set_value1 = set_value(1, "hola", 2, 3.0);
    printf("Clave 1: (1,'hola', 2, 3.0) -->resultado de set_value1=%d\n", status_set_value1);
    int status_set_value2 = set_value(2, "adios", 4, 5.0);
